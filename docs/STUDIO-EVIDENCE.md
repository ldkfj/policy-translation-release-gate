...
| Prior application-package external-wallet objection | [`0xe1b67acf6607c50fd9301d56ebb9bca25c799d2d7562cf9f694449e8d5dc1e7b`](https://explorer-studio.genlayer.com/tx/0xe1b67acf6607c50fd9301d56ebb9bca25c799d2d7562cf9f694449e8d5dc1e7b) | `FINALIZED / SUCCESS / MAJORITY_AGREE`; return `4`; objection ID `4` for candidate 16; deployment `dpl_AcLC5FenPms81vhyZwh1eJTdG9Dh`; historical application-package evidence |
| Current exact Vercel user objection E2E | [`0xcd1a63d8696dfa7b26330b3787234d4bf57032bfd0e706e483e25670869c5a01`](https://explorer-studio.genlayer.com/tx/0xcd1a63d8696dfa7b26330b3787234d4bf57032bfd0e706e483e25670869c5a01) | `FINALIZED / SUCCESS / MAJORITY_AGREE`; return `5`; objection ID `5` for candidate 16; deployment `dpl_CqGaE4eBT3qRcCvmtsGHEwYAM9Yi`; authoritative UI readback passed, then reload/disconnect and reconnect passed |
...
Project source is public at `https://github.com/ldkfj/policy-translation-release-gate`. The base evidence package is `404a7ccf8b0b828c6be7b98cc1567e0e380c85c1`; the current public evidence package HEAD is `50a53e164f3ff173557e2f5892399f569d03050f`. The refreshed production frontend is deployment `dpl_CqGaE4eBT3qRcCvmtsGHEwYAM9Yi` at `https://policy-translation-release-gate.vercel.app`. Primary browser smoke, fresh current-deployment external-wallet objection/readback, and user reload/disconnect/reconnect passed; POST_GITHUB_VERCEL_FINAL, DUAL_APPROVED, submission, and experience-ledger update remain.
